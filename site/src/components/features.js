    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 ">
            ...
            <Image
                ...
                <div className="ml-5">
                    <p class="h4 text-palette-15">One workspace, infinite workflows</p>
                ...
                <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                    ...
                    <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                        <div className="md:pl-4 lg:pl-12 xl:pl-16">
                            ...
                            <p className="text-xl text-palette-15 mb-4">You can use Pixel Vision OS or your computer’s file system to create folders, add PV8 games or create files in the Workspace folder. Any changes you make on your computer will show up in Pixel Vision OS’s Workspace drive.</p>
                            <ul className="text-lg text-palette-15 -mb-2">
                                <li className="flex items-center mb-2">
                                    <svg className="w-3 h-3 fill-current text-palette-14 mr-2 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                                ...
                                <li className="flex items-center mb-2">
                                    ...
                                    <span>Aseprite, Photoshop, and more</span>
                                </li>
                                <li className="flex items-center">
                                    <svg className="w-3 h-3 fill-current text-palette-14 mr-2 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
