        ...
        <div className="max-w-6xl mx-auto">
          <div className="pt-10 pb-12 md:pt-16 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4 text-palette-15" data-aos="fade-up">Share your games with others</h2>
            ...
            <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up">
                ...
                <h4 className="h4 mb-2 text-palette-15 pt-4">1. Create</h4>
                <p className="text-lg text-palette-15 text-center">Code games in Lua or C# .</p>
              </div>
              ...
              <div aria-hidden="true" className="absolute mt-3 h-1 border-t border-dashed border-palette-6 hidden md:block" style={{ width: 'calc(100% - 32px)', left: 'calc(50% + 48px)', top: '32px' }} data-aos="fade-in" data-aos-delay="200"></div>
                <Image
                  ...
                  width={92}
                  height={92} />
                <h4 className="h4 mb-2 pt-4">2. Play</h4>
                <p className="text-lg text-palette-15 text-center">Run games inside of PV8.</p>
              </div>
              ...
              <Image
                      ...
                      width={92}
                      height={92} />
                <h4 className="h4 mb-2 pt-4">3. Share</h4>
                <p className="text-lg text-palette-15 text-center">Export games as PV8 disks.</p>
              </div>
